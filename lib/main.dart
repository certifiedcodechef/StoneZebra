...
class _MyAppState extends State<MyApp> {
  ...
  Stream<StoneZebraFirebaseUser> userStream;
  StoneZebraFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = stoneZebraFirebaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  String _currentPage = 'mainMapView';
